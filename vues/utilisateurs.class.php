...
class VueUtilisateurs
{
    ...
    public static function formulaire_profil_html($utilisateurs)
    {
        $form = '';
    ...
    // fonction qui retourne la réponse au formulaires "inscription.html"
    // sert également à la mise à jour de l'utilisateur
